...
__Sharing the vehicle detailspage on socialmedia__  
The vehicle detailspage is created dynamically and so are the Open Graph tags that are used when sharing the page on socialmedia. It's important to disable Wordpress standard canonical url tag on this page and if Yoast Seo (or any other SEO plugin) plugin is used, either disable the autogenerated Open Graph tags completely or for the vehicle detailspage only.  
<br>
